    ...
    <>
      {isModalOpen && (
        <div className="bg-text bg-opacity-70  fixed inset-0 flex justify-center items-center  z-50 w-full mx-auto">
          ...
          <div
            id="closeModal"
            className="w-[977px] rounded p-6 h-[464px] mx-auto overflow-y-auto bg-white flex items-center gap-9 relative"
          >
            <div
              onClick={() => setIsModalOpen(false)}
              className="absolute top-3 right-5 mb-4"
            >
                ...
                <div className="border border-border h-full w-full rounded flex">
                  <div className="flex items-center gap-2 w-auto">
                    {CC.slice(0, 2).map((cc, index) => (
                      <div
                        key={index}
                        className="bg-[#F4F4F4] z-10 w-auto h-[30px] flex items-center gap-2 px-3 py-1 font-lato text-[14px] font-normal text-text rounded-[29px] ml-3"
                      >
                        {cc}
                        <img
                    ...
                    {CC.length > 2 && (
                      <p className=" z-10 font-lato text-[14px] font-normal text-text ml-3 flex gap-2">
